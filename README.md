...
**Contact / Next steps**
- If you want, I can:
  - Add a short example `configuration.nix` in `examples/` showing a minimal system import.
  - Add a small unit-test that verifies the generated `systemd` unit text contains the expected `ExecStart`.
